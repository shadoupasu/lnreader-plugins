...
import { Plugin, NovelItem, NovelDetails, ChapterItem } from "@tmrace/lnreader-plugin-utils";
...
// DEĞİŞİKLİK BURADA: new NovelOkuTR() yerine sınıfın kendisini dışa aktarıyoruz
